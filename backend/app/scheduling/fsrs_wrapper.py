...
def advance_card_state(existing_state: dict, grade: int) -> dict:
    """
    ...
    return {
        ...
        "last_review": updated_card.last_review.isoformat() if updated_card.last_review else datetime.now(timezone.utc).isoformat(),
    }